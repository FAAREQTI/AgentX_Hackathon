            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
              ...
              <div className="flex-1 space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground text-lg">{profileData.department}</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input value={profileData.startDate} disabled className="pl-10" />
                        </div>
                      </div>
                      ...
                      {[
                        ...
                        <div key={index} className="flex items-center gap-4 p-3 rounded-lg hover:bg-muted/50 transition-colors">
                          <div className={cn(
                            ...
                            activity.type === "auth" ? "bg-primary" :
                            activity.type === "review" ? "bg-warning" :
                            activity.type === "solution" ? "bg-success" :
                            activity.type === "profile" ? "bg-accent" : "bg-muted-foreground"
                          )} />
