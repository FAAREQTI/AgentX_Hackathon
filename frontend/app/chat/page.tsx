...
export default function ChatPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: "system",
      content:
        "Welcome to Complaint Intelligence Chat! I'm here to help you file and analyze complaints using our AI-powered system. Please describe your complaint in detail.",
      timestamp: new Date(),
    },
  ]);
  ...
  const { workflowState, submitComplaint } = useComplaintWorkflow();
  ...
  const generateCompletionMessage = (results: any) => {
    ...
    const strategy =
      results.solution?.primary_solution?.resolution_strategy ||
      "Standard resolution";

    return `✅ **Analysis Complete!**

📊 **Risk Assessment**: ${riskCategory.toUpperCase()} risk (${(
      riskScore * 100
    ).toFixed(0)}% score)
🔍 **Similar Cases**: Found ${similarCount} similar complaints in our database
💡 **Recommended Strategy**: ${strategy}
⏱️ **Estimated Resolution**: ${
      results.solution?.primary_solution?.estimated_resolution_time || "TBD"
    }
        ...
        <div className="flex-1 flex flex-col">
                  ...
                  >
                    <div className="space-y-2">
                          ...
                          {message.metadata.agent && (
                            <>
                              ...
                              <span className="capitalize">
                                {message.metadata.agent.replace("_", " ")}
                              </span>
                            </>
                          )}
                      ...
                      {message.type === "assistant" &&
                        message.metadata?.step === "completed" && (
          ...
          <div className="border-t bg-background p-6">
            <div className="max-w-4xl mx-auto">
              ...
              {workflowState.complaint_id &&
                workflowState.status === "completed" && (
                  <div className="flex gap-2 mt-4">
                    <Link
                      href={`/letters?complaint_id=${workflowState.complaint_id}`}
                    >
